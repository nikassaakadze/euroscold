                  ...
                  <ul>
                    {
                      product.name !== "" ? (
                        <li>
                        <span className="specName">Name</span>
                    ...
                    }
                    {
                      product.info !== "" ? (
                        <li>
                        <span className="specName">About Product</span>
                        <span className="specValue">{product.info}</span>
                        </li>
                      ):("")
                    }
                    {
                      product.type !== "" ? (
                        <li>
                        <span className="specName">Type of refregerator</span>
                    ...
                    }
                    {
                      product.prodVolume !== "" ? (<li>
                        <span className="specName">Refrigerator capacity</span>
                    ...
                    }
                    {
                      product.prodareal !== ""?(
                        <li>
                      <span className="specName">Product scope </span>
                    ...
                    }
                    {
                        product.tempdiapason !== "" ? (                    <li>
                          <span className="specName">Temperature range</span>
                      ...
                      }
                    {
                      product.voltagenomin !== "" ? (
                        <li>
                        <span className="specName">Rated voltage</span>
                    ...
                    }  
                      {
                          product.freon !== "" ? (                   
                             <li>
                            <span className="specName">Refrigerant</span>
                            <span className="specValue warning">{product.freon}</span>
                          </li>):("")
                        }  
                    {
                      product.cooling !== "" ? (                    <li>
                        <span className="specName">Cooling</span>
                    ...
                    {
    product.shreder !== "" ? (                    <li>
      <span className="specName">Freon filling valve</span>
...
{
    product.trv !== "" ? (                    <li>
      <span className="specName">Thermostatic valve</span>
      <span className="specValue">{product.trv}</span>
    </li>):("")
  }  
  {
    product.elBlok !== "" ? (                    <li>
      <span className="specName">Electronic control unit</span>
  ...
  }  
    {
      product.led !== "" ? (
        <li>
      <span className="specName">LED lightening</span>
...
{
    product.drenage !== "" ? (                    <li>
      <span className="specName">Drainage equipment</span>
      <span className="specValue">{product.drenage}</span>
    </li>):("")
  }  
  {
    product.length !== "" ? (                    <li>
      <span className="specName">Length</span>
  ...
  {
    product.width !== "" ? (                    <li>
      <span className="specName">Width</span>
      <span className="specValue">{product.width}</span>
    </li>):("")
  }  
  {
    product.height !== "" ? (                    <li>
      <span className="specName">Height</span>
  ...
  }  
  {
    product.deep !== "" ? (
      <li>
      <span className="specName">Depth</span>
...
{
    product.decibel !== "" ? (                    <li>
      <span className="specName">Noise level</span>
  ...
  }  
{
    product.universal !== "" ? (                    <li>
      <span className="specValue aloneval">Universal{product.universal}</span>
    </li>):("")
  }  
  {
    product.condit !== "" ? (                    <li>
      <span className="specValue aloneval">Confectionery: {product.condit}</span>
    </li>):("")
  }  
  {
    product.fish !== "" ? (                    <li>
      <span className="specValue aloneval">For fish: {product.fish}</span>
    </li>):("")
  }  
  {
    product.move !== "" ? (                    <li>
...

{
    product.evels !== "" ? (
      ...
      <li>
        <span className="specValue aloneval">{product.evels} Row of shelves</span>
      </li>):("")
  }  
  {
    product.levelsligh !== "" ? (
  ...
  {
    product.lowtemp !== "" ? (                    <li>
      <span className="specValue aloneval">Low temperature: {product.lowtemp}</span>
    </li>):("")
  }  
  {
    product.ten !== "" ? (
